    ...
    <section id="contact" className="py-20 bg-white dark:bg-gray-900 relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                initial="hidden"
                animate={inView ? 'visible' : 'hidden'}
                className="bg-white dark:bg-gray-700 p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-600 hover:border-primary dark:hover:border-blue-400 transition-all text-center hover:shadow-xl"
                whileHover={{ y: -5 }}
              >
                <div className="text-3xl sm:text-4xl text-primary dark:text-blue-400 mb-3 sm:mb-4 flex justify-center">{info.icon}</div>
          ...
          >
            <div className="bg-white dark:bg-gray-700 p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-600 hover:shadow-xl">
              {submitSuccess && (
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="mb-4 sm:mb-6 p-3 sm:p-4 bg-green-50 border border-green-300 rounded-lg text-green-700 text-center text-sm sm:text-base">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    <label htmlFor="name" className="block text-gray-900 dark:text-white font-medium mb-2 text-sm sm:text-base">
                      Your Name
                    </label>
                    <input
                      type="text"
                      ...
                      className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-gray-50 dark:bg-gray-800 border ${
                  ...
                  <div>
                    <label htmlFor="email" className="block text-gray-900 dark:text-white font-medium mb-2 text-sm sm:text-base">
                      Your Email
                    </label>
                    <input
                      type="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-gray-900 dark:text-white font-medium mb-2 text-sm sm:text-base">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="message" className="block text-gray-900 dark:text-white font-medium mb-2 text-sm sm:text-base">
                    Message
                  </label>
                  <textarea
                    id="message"
                ...
                <motion.button
                  ...
                  className={`w-full px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base bg-primary hover:bg-blue-600 text-white font-semibold rounded-full transition-all shadow-lg hover:shadow-xl flex items-center justify-center ${
